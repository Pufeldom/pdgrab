...
На основе этих файлов (и других, дополняющих их) формируются CSV- и XML-файлы для различных площадок (Bitrix, Wix, 
Яндекс, Юла и т.д.)
...
**Идентификаторы полей** (латиница без пробелов) нужны для прокидывания значений в момент генерации файлов.
...
* напрямую в веб-редакторе github: https://github.com/Pufeldom/pdgrab/blob/master/
